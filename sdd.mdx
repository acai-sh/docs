...
description: "Integrate Acai into your workflow to increase productivity and generate higher quality software."
...
<Card title="Features are toggleable" icon="toggle-left" horizontal>
  A good feature can be delivered on it's own, and can be toggled with a feature flag. If you can't flag it, it might be too small (a task) or too large (a product).
</Card>
