...
description: "This is the formal specification for the FRD.yaml format (itself written as a compliant FRD.yaml!)"
sidebarTitle: "FRD.yaml"
mode: "wide"
---
...
components:
    ...
    REQUIREMENT:
        ...
        requirements:
            ...
            4: Sub-requirement keys must never include `-0` as the parent requirement is implicity the 0th item.
            5: Requirements may be written as any yaml compatible string, including multi-line blocks with markdown, gherkin, etc.
            6: Requirement definitions must be describe functional and objective criteria that can be verified as acceptable or not.
