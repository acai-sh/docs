...
The Acai Command Line Interface (CLI) is your local gateway to spec-driven development. It allows you to parse your local `FRD.yaml` specification files, sync them to the Acai platform, and interact with your requirements directly from your terminal.
...
<CardGroup cols={2}>
  <Card
    ...
    href="/writing-specs"
  >
    Learn the syntax and best practices for writing your `FRD.yaml` specs.
  </Card>
  <Card
    title="Dashboard"
