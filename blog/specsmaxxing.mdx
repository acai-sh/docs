...
When code is generated faster than you can read it, the bottleneck is becomes QA and validation and your *confidence* that the code is to-spec and can be shipped. So investing heavily in QA automation and test coverage has a massive ROI.
...
It seems every well-funded software team on earth is currently busy building their own bespoke solution for this and I'm excited to see what works and what doesn't.
