...
- Acai requires you to adopt the **feature.yaml** format. Almost zero learning curve. I have written an [introductory guide](/writing-specs) to writing them. Use `npx acai skill` to teach your agent how to. We also have a [spec-for-the-spec](/feature-yaml) if you want to go deeper.
