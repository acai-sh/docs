...
- I want to spend more time studying how other teams write their specs, and explore better alternatives.
...
- Acai requires you to adopt the **feature.yaml** format. Almost zero learning curve. I have written an [introductory guide](/spec-driven-development) to writing them. I recommend reading that first. Use `npx @acai.sh/cli skill` to teach your agent how. I also wrote a [spec-for-the-spec](/feature-yaml) if you want to go deeper.
