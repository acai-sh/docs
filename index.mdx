...
<Frame caption="Useful tools for collaboration between humans or agents">
  <img
      src="/images/comment-example.png"
      alt="Example of a comment and a rejected requirement status"
  />
</Frame>
...
<Frame caption="Acai handles the complex journey of a feature and it's spec, even across repos and branches">
  <img
      src="/images/desktop-feature-view.png"
      alt="Example dashboard showing details about a specific feature requirement"
  />
</Frame>
