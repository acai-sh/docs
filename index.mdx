...
<Frame caption="See implementation status at a glance">
  <img src="/images/implementation.png" alt="Example dashboard showing status updates for implementation of a feature" />
</Frame>

<Frame caption="Drill down on specific requirements, quickly find relevant tests and code.">
  <img src="/images/requirement-details.png" alt="Example dashboard showing details about a specific feature requirement." />
</Frame>
...
As shown above, acai gives each requirement an ID that is unique, stable, and readable. These IDs can be referenced anywhere (in tests, comments, and other specs), and are extracted from code by Acai.
