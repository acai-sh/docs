...
Acai.sh is a set of tools to assist with software development. Acai helps humans write simple [Feature Requirement Docs](./writing-specs). Your feature requirements are automatically surfaced to agents and to your team via MCP, CLI, API and a dashboard.

This unlocks a spec-driven development workflow that replaces messy GitHub and Linear tickets. You, your agent swarm, and your product manager can all **share implementation progress, track acceptance coverage, track test coverage, validate changes, and more**.

Acai.sh is open source.
...
I will draft a solid `feature.yaml` based on your notes.
...
<Steps>
    ...
    <Step title="Specify">
        Define your next feature by writing key requirements in `feature.yaml`.
    </Step>
    <Step title="Sync">
...
```yaml features/block-user/feature.yaml
# This is an example spec, following our feature.yaml conventions
feature:
