...
This guide provides a minimal introduction. For the complete, formal specification of `Feature.yaml` itself, please see the [feature.yaml Specification](/feature-yaml).

## What is a feature spec?

A feature spec is typically a YAML file named `feature.yaml` that lives inside a feature folder in your repository. It defines what a specific feature does and what its acceptance criteria are.
