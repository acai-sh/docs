...
The feature boundary is up to you, but it can help to break up products into many small features. That way specs are easy to read and easy to ship.
...
**Avoid** superficial requirements (aesthetics, copywriting, etc.) unless they are mission-critical. Otherwise your spec will grow too large and your product will grow too rigid.

**Avoid** specifying things that are obvious. Have faith your developers can fill in the gaps!

If you find yourself duplicating requirements in many specs, consider creating a `core.feature.yaml` or just putting those rails in `AGENTS.md` and other developer docs.
