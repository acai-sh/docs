...
This page is a quick intro and cheatsheet for writing spec docs following the `feature.yaml` standard.
...
The basic feature spec has two main sections:
...
Ready to dive deeper? Check out the full [feature.yaml](/feature-yaml) specification.
